  ...
  <div class="bg-white p-4">
      <nav class="text-[#4311A5] font-poppins text-2xl">
        <ol class="list-reset flex">
          ...
          <li><span class="mx-2">&gt;</span></li>
          <li>
            <a class="text-black hover:text-[#4311A5]" href="budget_allocation.php">Budget Estimation Quarterly</a>
          </li>
        </ol>
      </nav>
    </div>
    ...
    <div class="flex-1  p-6">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="bg-white p-4 rounded-lg shadow-lg border border-gray-300">
                ...
                <div class="mb-4">
                    <div class="flex justify-between mb-2 border border-gray-300">
