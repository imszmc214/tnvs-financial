...
<body class="bg-blue-100 overflow-hidden">
    ...
    <div class="overflow-y-auto h-full px-6">
        ...
        <nav class="text-[#4311A5] font-poppins text-2xl">
            ...
            <li><span class="mx-2">&gt;</span></li>
            <li>
                <a class="text-black hover:text-[#4311A5]" href="budget_allocation.php">Budget Estimation Monthly</a>
            </li>
            </ol>
        </nav>
        </div>
        ...
        <div class="flex-1 p-6 w-full">
            ...
            <div class="w-full">
                ...
                <div class="flex items-center justify-start gap-6 mb-8 border-b border-gray-300 text-m font-medium w-full">
